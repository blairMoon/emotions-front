...
`
const Bold = styled.span `font-weight: 800;
...
const Modal = ({ selectedEmotion, onClose, currentDate }) => {
 ...
 <ModalText>{currentDate}의 감정이는 <br/> <Bold>{emotionData.label}</Bold>이에요</ModalText> 
 <CustomSubmitButton onClick={onClose}>감정 캘린더로 이동하기</CustomSubmitButton>
